...
st.set_page_config(page_title="S-Chatbot",page_icon=":robot_face:")
st.markdown("<h1 style='text-align:center;'>How can I help you?</h1>",unsafe_allow_html=True)

st.sidebar.title("S-Chatbot")
st.session_state['API_Key'] = st.sidebar.text_input("Paste your GooglePalm API key",type="password")
